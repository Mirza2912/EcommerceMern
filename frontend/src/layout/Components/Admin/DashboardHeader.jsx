  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <div>
        ...
        <p className="text-gray-400">Welcome back to Logo Admin</p>
      </div>

      <div className="flex items-center gap-2">
        <button className="rounded-full p-2 border border-gray-100 text-[#F7FAFC] hover:text-gold hover:border-[gold] ">
          <svg
